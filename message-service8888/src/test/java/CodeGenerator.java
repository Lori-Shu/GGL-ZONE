...
public class CodeGenerator {
    ...
    .globalConfig(builder -> {
        ...
        // 覆盖已生成文件
            .outputDir("E:\\GGL-ZONE\\message-service8888\\src\\main\\java"); // 指定输出目录
    })
    .packageConfig(builder -> {
        builder.parent("com.ggl.cloud") // 设置父包名
            .moduleName("") // 设置父包模块名
            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "E:\\GGL-ZONE\\message-service8888\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
    })
